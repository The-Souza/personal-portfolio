...
const navigationMenuTriggerStyle = cva(
  ...
  "data-[state=open]:focus:bg-accent data-[state=open]:bg-accent/50 focus-visible:ring-ring/50 outline-none" +
  "transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 data-[active=true]:bg-accent/60 " +
  "data-[active=true]:text-accent-foreground data-[active=true]:-translate-y-0.5 data-[active=true]:shadow-md " +
  "data-[active=true]:ring-[3px] data-[active=true]:ring-ring/50 transition-all"
);
